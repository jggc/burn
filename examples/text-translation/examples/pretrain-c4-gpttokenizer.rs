...
use text_translation::{data::C4DatasetPretrain, training::ExperimentConfig, Gpt2Tokenizer};
...
fn main() {
    ...
    let dataset_train = C4DatasetPretrain::new("train");
    let dataset_valid = C4DatasetPretrain::new("validation");

    text_translation::training::train::<Backend, C4DatasetPretrain>(
        ...
        "/tmp/text-translation-c4-gpt2tokenizer",
        // None,
        Some(20),
    );
}
