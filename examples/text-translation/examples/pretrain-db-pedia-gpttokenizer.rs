...
use text_translation::{training::ExperimentConfig, PretrainDbPediaDataset, Gpt2Tokenizer};
...
fn main() {
    ...
    text_translation::training::train::<Backend, PretrainDbPediaDataset>(
        ...
        PretrainDbPediaDataset::train(),
        PretrainDbPediaDataset::test(),
        config,
        Arc::new(Gpt2Tokenizer::default()),
        "/tmp/text-translation-pretrain-batch12-dbpedia-gpt2tokenizer",
        None,
    );
}
